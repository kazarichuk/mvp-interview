...
import { Candidate, CandidateData } from '@/types/candidates'
...
export const AddCandidateModal: React.FC<AddCandidateModalProps> = ({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create invitation
      const inviteResult = await createInvite(user.uid, position);
      ...
      const candidateResult = await addCandidate(inviteResult.inviteCode, candidateData);
      ...
      const validationResult = await validateInterviewSession(inviteResult.inviteCode, email);
      ...
      const emailResult = await sendInterviewInviteEmail(email, name, inviteLink);
